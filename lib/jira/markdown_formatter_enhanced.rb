...
module Jira
  # Enhanced Markdown formatter - high-quality local ADF conversion for JIRA
  # This is the primary conversion method, optimized for JIRA's ADF format
  class MarkdownFormatterEnhanced
