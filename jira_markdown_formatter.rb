...
# Shared module for converting Markdown to Atlassian Document Format (ADF)
# Used by both create_jira_ticket and update_jira_ticket scripts

module JiraMarkdownFormatter
